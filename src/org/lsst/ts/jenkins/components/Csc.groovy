...
def email() {
    emails = [  "default": "rubinobs-tssw-worker@lsst.org",
                ...
                "lsst-efd-client": "vbecker@lsst.org",
                ...
                "ts-atmcs": "wvreeven@lsst.org",
                "ts-atpneumatics": "wvreeven@lsst.org",
                ...
                "ts-dimm": "bbrondel@lsst.org",
                "ts-dream": "bbrondel@lsst.org",
                "ts-dsm": "mreuter@lsst.org",
                "ts-eas": "bbrondel@lsst.org",
                ...
                "ts-lasertracker": "ecoughlin@lsst.org, pkubanek@lsst.org",
                ...
                "ts-planning-tool": "saranda@lsst.org",
