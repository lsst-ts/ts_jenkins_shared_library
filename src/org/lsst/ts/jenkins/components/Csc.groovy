...
def email() {
    emails = ["ts-ataos":"tribeiro@lsst.org", "ts-atdome":"rowen@uw.edu", "ts-athexapod":"ecoughlin@lsst.org", "ts-atmcs": "rowen@uw.edu", "ts-atpneumatics": "rowen@uw.edu", "ts-atsprectrograph": "rowen@uw.edu", "ts-cbp": "ecoughlin@lsst.org", "ts-dimm": "wvreeven@lsst.org", "ts-dsm": "wvreeven@lsst.org", "ts-eas": "wvreeven@lsst.org", "ts-electrometer": "ecoughlin@lsst.org", "ts-ess": "wvreeven@lsst.org", "ts-externalscripts": "tribeiro@lsst.org", "ts-fiberspectrograph": "rowen@uw.edu", "ts-hexrotcomm": "rowen@uw.edu", "ts-m2": "ttsai@lsst.org", "ts-mtdome": "rowen@uw.edu", "ts-mtdometrajectory": "rowen@uw.edu", "ts-mteec": "wvreeven@lsst.org", "ts-mthexapod": "rowen@uw.edu", "ts-mtmount": "rowen@uw.edu", "ts-mtrotator": "rowen@uw.edu", "ts-observatorycontrol":"tribeiro@lsst.org", "ts-salkafka": "tribeiro@lsst.org", "ts-simactuators": "rowen@uw.edu", "ts-standardscripts": "tribeiro@lsst.org", "ts-tunablelaser": "ecoughlin@lsst.org", "ts-watcher": "rowen@uw.edu", "ts-weatherstation": "wvreeven@lsst.org"]
    return emails
}
